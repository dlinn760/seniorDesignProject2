...
cam_list = webcamlist;
cam_name = cam_list{1}; % Change index to 1 to use your laptop's webcam
cam = webcam(cam_name);
preview(cam)
% 
% %% Take Snapshot
...
for i=1:height
    for j=1:width
        if (Image_BackgroundSub(i,j,1) > 45) || ...
           (Image_BackgroundSub(i,j,2) > 45) || ...
           (Image_BackgroundSub(i,j,3) > 45)
